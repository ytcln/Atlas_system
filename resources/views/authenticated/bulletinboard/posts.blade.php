      ...
      <div class="post_bottom_area d-flex" style="justify-content:right">
        <div class="d-flex post_status">
          ...
          <div>
            ...
            <p class="m-0"><i class="fas fa-heart un_like_btn" post_id="{{ $post->id }}"></i><span class="like_counts{{ $post->id }}"></span></p><span class="like_count">{{$post->likeCounts($post->like_post_id)}}</span>
            @else
